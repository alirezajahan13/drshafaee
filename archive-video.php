...
<main id="primary" class="site-main mainView">
		<h1 class="highMargined centeredText bottomBorder">ویدیو ها</h1>
		<div class="categoryVideosButtonMob">
			<svg width="20" height="20" fill="#2c62d6" viewBox="0 0 0.6 0.6" xmlns="http://www.w3.org/2000/svg" transform="rotate(180)"><path fill-rule="evenodd" d="M.55.425v.05H.2v-.05zm0-.15v.05H.2v-.05zm0-.15v.05H.2v-.05zM.1.5a.05.05 0 1 1 0-.1.05.05 0 0 1 0 .1m0-.15a.05.05 0 1 1 0-.1.05.05 0 0 1 0 .1M.1.2a.05.05 0 1 1 0-.1.05.05 0 0 1 0 .1"/></svg>
