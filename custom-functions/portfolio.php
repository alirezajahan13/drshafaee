...
//   $filterData = $_POST['filterData'];
    $requestGallery = $_POST['requestGallery'];
    ob_start();
    $theGalleryItems = get_field('drs_custom_mb_gallery_items' , $requestGallery);
    // return 'test';
    foreach($theGalleryItems as $gItems){
        echo '<a href="'.$gItems['photo']['url'].'"><img src="'.$gItems['photo']['url'].'" alt=""></a>';
    }
//   echo '<div>some test</div>';
  /*
  $testtest =  array(
