...
<div class="searchContainer highRadius mediumPadding mediumMargined">
    <form action="/" method="get">
		...
		<div class="searchButtonContainer">
			<button  type="submit" class="generalButton" fdprocessedid="x887ac">البحث</button>
			<a class="generalButton outlineButton noArrowButton closeSearchBtn">إغلاق</a>
		</div>
    </form>
...
<div id="page" class="site">
	<div class="mainHeaderBack">
		<div class="mainHeader mainView">
			...
			<a class="generalButton outlineButton CounselingBtn" href="https://www.drshafaee.com/book-appointment/">حجز موعد</a>
		</div>
	</div>
	...
	<div class="stickyPhoneIcon">
		<a href="tel://09927270343" class="phoneNumberSticky">
			<span class="textAnimation">حجز موعد</span>
